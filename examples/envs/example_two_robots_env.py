...
BOX = (.07, .05, .15)
ExampleTwoRobotsCameraSetup = [(0, -1, 4), (0, 0, 0)]

class ExampleTwoRobotsEnvironment(Environment):
    ...
    def _create_problem_2obj(self, other_arm, initial_conf):
        ...
        self.m_objs = boxes
        self.f_objs = [table[0], table[1]]
        self.m_obj_in_f_obj = {table[0]: set([boxes[0]]),
                               table[1]: set([boxes[1]])}